...
./scripts/registries/services.json
./scripts/comprehensive-task-audit.sh
./scripts/comprehensive-framework-search.sh
./backups/20250819-mass-refactoring/pre-refactoring-state/registries/services.json
./CLAUDE.md
```

### Pattern: 'Task tool' (      37 files)
```
...
./docs/principles/task-tool-syntax.md
./scripts/remove-deployment-capabilities.sh
./scripts/comprehensive-task-audit.sh
./scripts/comprehensive-framework-search.sh
...
./todos/71101acc-0b16-4a9d-ac8e-d4a8bdceb720-agent-71101acc-0b16-4a9d-ac8e-d4a8bdceb720.json
./todos/711be30e-7e8b-4dbe-baed-e70a9fcd16f2-agent-711be30e-7e8b-4dbe-baed-e70a9fcd16f2.json
./todos/a120ec78-e3d9-42fd-a98e-82b269dc632b-agent-84081016-75ac-49f1-952f-cc8f50f3857d.json
./todos/a4966aac-9b04-403d-b793-b17d60bd6750-agent-a4966aac-9b04-403d-b793-b17d60bd6750.json
./todos/a120ec78-e3d9-42fd-a98e-82b269dc632b-agent-a120ec78-e3d9-42fd-a98e-82b269dc632b.json
./todos/5789002e-8771-45a3-88cc-3a32dbb6740d-agent-47735df2-c59a-456a-89fe-d8082bf93d70.json
./todos/a3498b9c-11d3-4cbb-8194-5f3a6e72f803-agent-a3498b9c-11d3-4cbb-8194-5f3a6e72f803.json
./todos/b6ab4d15-ccc8-4192-88bd-e6e1c4e63b80-agent-b6ab4d15-ccc8-4192-88bd-e6e1c4e63b80.json
...
### Pattern: 'TodoWrite' (     140 files)
```
./planning/tickets/completed/agent-001-ticket-executor-agent.md
./docs/agents-docs/agent-template.md
./scripts/registries/agents.json
./scripts/remove-deployment-capabilities.sh
./scripts/comprehensive-task-audit.sh
./scripts/final-orchestration-cleanup.sh
./scripts/comprehensive-framework-search.sh
./scripts/fix-orchestration-removal.sh
./templates/yaml/agent-frontmatter-template.yaml
./commands/domains/management/commands/manage-systems.md
./automation/registry-management/schemas/agent-registry-schema.json
./backups/20250819-mass-refactoring/pre-refactoring-state/registries/agents.json
...
### Pattern: 'subagent_type' (      14 files)
```
...
### Pattern: 'Task Framework' (       1 files)
```
./scripts/comprehensive-task-audit.sh
```

### Pattern: 'Task Tool Framework' (       4 files)
```
./planning/tickets/completed/int-ana-001-analytics-agents-task-registration.md
./scripts/comprehensive-task-audit.sh
./backups/20250819-mass-refactoring/pre-refactoring-state/agents/specialization/AGENT-006-workflow-coordinator.md
...
### Pattern: 'task tool' (       2 files)
```
./scripts/comprehensive-task-audit.sh
./scripts/comprehensive-framework-search.sh
```

### Pattern: 'orchestrator.*Task' (       3 files)
```
./docs/principles/agent-definition.md
./scripts/comprehensive-task-audit.sh
./CLAUDE.md
