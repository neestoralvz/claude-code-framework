...
## Navigation
[Previous: Architecture Standardization Workflows](architecture-standardization-workflows.md) | [Return to documentation hub](../philosophy/index.md) | [Next: Component Architecture Specialist](../../../agents/development/architecture/component-architecture-specialist.md)
