...
**Quick Links**: [Commands](../commands/index.md) | [Commands Reference](commands-reference.md) | [Main Guide](../CLAUDE.md) | [Core Principles](principles/README.md) | [Agents](../agents/) | [Architecture](architecture/)
...
**📚 Command Reference Guide**: [Complete Commands Reference](commands-reference.md) - Comprehensive guide to all 122+ commands with task-oriented navigation
...
- **Use the comprehensive commands reference for user-focused navigation** - Access [commands-reference.md](commands-reference.md) for task-oriented command selection
- **Review the agent documentation guide**

### Project Planning

- **Monitor the ticket registry for project status** - Access [TICKET_REGISTRY.md](../planning/TICKET_REGISTRY.md) for centralized ticket tracking
...
- **Use the commands reference guide for task-based command selection** - Access [commands-reference.md](commands-reference.md) for user-focused navigation
...
- **Apply directive principles for ultimate authority** - Use [directive.md](principles/core-authority/directive.md) for command adherence patterns
- **Follow fundamental principles for methodology** - Use [fundamental.md](principles/core-authority/fundamental.md) for basic methodology  
- **Apply content-deduplication principles** - Use [content-deduplication.md](../operations/content-deduplication.md) for single-source truth
- **Use communication principles for clarity** - Use [communication.md](principles/content-management/communication.md) for direct communication
- **Apply simplicity principles for essential content** - Use [simplicity.md](principles/quality-assurance/simplicity.md) for essential information only
...
- **Apply ValidationFramework for extensible validation** - Use [ValidationFramework.md](../commands/foundation/core/ValidationFramework.md) for reusable validation systems

### System Architecture
- **Access system architecture overview for complete framework understanding** - Use [system-architecture-overview.md](architecture/core/system-architecture-overview.md) for comprehensive architecture, SOLID compliance, and integration patterns
